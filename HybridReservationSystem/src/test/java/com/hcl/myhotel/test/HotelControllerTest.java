package com.hcl.myhotel.test;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.hcl.myhotel.*;
import com.hcl.myhotel.api.rest.*;
import com.hcl.myhotel.domain.*;
...
public class HotelControllerTest {
    ...
    private static final String RESOURCE_LOCATION_PATTERN = "http://localhost:8081/hotel/[0-9]+";
   ...
   /* @Test
    ...
    public void shouldCreateRetrieveDelete() throws Exception {
        ...
        //CREATE
        MvcResult result = mvc.perform(post("/hotel")
                .content(r1Json)
